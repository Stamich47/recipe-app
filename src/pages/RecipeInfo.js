      ...
      {currentWidth <= 640 && (
        <div className="mt-4">
          <button
            ...
            className="dropdown-toggle font-bold py-2 rounded mb-4 flex items-center bg-blue-200 px-4 hover:bg-blue-300 transition-colors duration-300 w-full justify-center"
          >
            {!showSummary ? (
              <>
                <FaArrowRight className="inline-block mr-2" /> Summary
              </>
            ) : (
              <>
      ...
      {currentWidth <= 640 && (
        <div className="mt-4">
          <button
            ...
            className="dropdown-toggle font-bold py-2 rounded mb-4 flex
            items-center bg-blue-200 px-4 hover:bg-blue-300 transition-colors
            duration-300 w-full justify-center"
          >
            {!showIngredients ? (
              <>
                <FaArrowRight className="inline-block mr-2" /> Ingredients
              </>
            ) : (
              <>
      ...
      {currentWidth <= 640 && (
        <div className="mt-4">
          ...
          >
            {!showInstructions ? (
              <>
                <FaArrowRight className="inline-block mr-2" /> Instructions
              </>
            ) : (
              <>
                <FaArrowDown className="inline-block mr-2" /> Hide Instructions
              </>
            )}
          </button>
          {showInstructions && (
